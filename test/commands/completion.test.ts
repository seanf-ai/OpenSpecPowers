...
vi.mock('../../src/core/completions/installers/zsh-installer.js', () => ({
  ZshInstaller: vi.fn().mockImplementation(() => ({
    install: vi.fn().mockResolvedValue({
      success: true,
      installedPath: '/home/user/.oh-my-zsh/completions/_openspecpowers',
      isOhMyZsh: true,
    ...
    uninstall: vi.fn().mockResolvedValue({
      success: true,
      message: 'Completion script removed from /home/user/.oh-my-zsh/completions/_openspecpowers',
    }),
  })),
}));
...
describe('CompletionCommand', () => {
  ...
  describe('generate subcommand', () => {
    it('should generate Zsh completion script to stdout', async () => {
      ...
      expect(output).toContain('#compdef openspecpowers');
      expect(output).toContain('_openspecpowers() {');
    });
