...
describe('tool-detection', () => {
  ...
  describe('SKILL_NAMES', () => {
    it('should contain all skill names matching COMMAND_IDS', () => {
      ...
      expect(SKILL_NAMES).toContain('openspecpowers-explore');
      expect(SKILL_NAMES).toContain('openspecpowers-new-change');
      expect(SKILL_NAMES).toContain('openspecpowers-continue-change');
      expect(SKILL_NAMES).toContain('openspecpowers-apply-change');
      expect(SKILL_NAMES).toContain('openspecpowers-ff-change');
      expect(SKILL_NAMES).toContain('openspecpowers-sync-specs');
      expect(SKILL_NAMES).toContain('openspecpowers-archive-change');
      expect(SKILL_NAMES).toContain('openspecpowers-bulk-archive-change');
      expect(SKILL_NAMES).toContain('openspecpowers-verify-change');
      expect(SKILL_NAMES).toContain('openspecpowers-onboard');
      expect(SKILL_NAMES).toContain('openspecpowers-propose');
    });
  });
  ...
  describe('getToolSkillStatus', () => {
    ...
    it('should detect when one skill exists', async () => {
      const skillDir = path.join(testDir, '.claude', 'skills', 'openspecpowers-explore');
