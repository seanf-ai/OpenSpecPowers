...
describe('command-generation/generator', () => {
  ...
  describe('generateCommand', () => {
    it('should generate command with path and content using Claude adapter', () => {
      ...
      expect(result.fileContent).toContain('name: OpenSpecPowers Explore');
    ...
    it('should generate command with path and content using Cursor adapter', () => {
      ...
      expect(result.path).toContain('opsp-explore.md');
      expect(result.fileContent).toContain('name: /opsp-explore');
      expect(result.fileContent).toContain('id: opsp-explore');
      expect(result.fileContent).toContain('Command body here.');
    });
    ...
    it('should work with custom adapter', () => {
      ...
      expect(result.fileContent).toBe('# OpenSpecPowers Explore\n\nCommand body here.');
    });
  });
