...
describe('command-generation/adapters', () => {
  ...
  describe('claudeAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.claude', 'commands', 'opsp', 'explore.md'));
    });

    it('should generate correct file path for different command IDs', () => {
      expect(claudeAdapter.getFilePath('new')).toBe(path.join('.claude', 'commands', 'opsp', 'new.md'));
      expect(claudeAdapter.getFilePath('bulk-archive')).toBe(path.join('.claude', 'commands', 'opsp', 'bulk-archive.md'));
    });
    ...
    it('should format file with correct YAML frontmatter', () => {
      ...
      expect(output).toContain('name: OpenSpecPowers Explore');
  ...
  describe('cursorAdapter', () => {
    ...
    it('should generate correct file path with opsp- prefix', () => {
      const filePath = cursorAdapter.getFilePath('explore');
      expect(filePath).toBe(path.join('.cursor', 'commands', 'opsp-explore.md'));
    });

    it('should generate correct file paths for different commands', () => {
      expect(cursorAdapter.getFilePath('new')).toBe(path.join('.cursor', 'commands', 'opsp-new.md'));
      expect(cursorAdapter.getFilePath('bulk-archive')).toBe(path.join('.cursor', 'commands', 'opsp-bulk-archive.md'));
    });
    ...
    it('should format file with Cursor-specific frontmatter', () => {
      ...
      expect(output).toContain('---\n');
      expect(output).toContain('name: /opsp-explore');
      expect(output).toContain('id: opsp-explore');
      expect(output).toContain('category: Workflow');
      expect(output).toContain('description: Enter explore mode for thinking');
      expect(output).toContain('---\n\n');
      expect(output).toContain('This is the command body.');
  ...
  describe('windsurfAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.windsurf', 'workflows', 'opsp-explore.md'));
    });
  ...
  describe('amazonQAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.amazonq', 'prompts', 'opsp-explore.md'));
    });
  ...
  describe('antigravityAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.agent', 'workflows', 'opsp-explore.md'));
    });
  ...
  describe('auggieAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.augment', 'commands', 'opsp-explore.md'));
    });
  ...
  describe('clineAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.clinerules', 'workflows', 'opsp-explore.md'));
    });

    it('should format file with markdown header (no YAML frontmatter)', () => {
      const output = clineAdapter.formatFile(sampleContent);
      expect(output).toContain('# OpenSpecPowers Explore');
  ...
  describe('codexAdapter', () => {
    ...
    it('should generate path ending with correct structure', () => {
      const filePath = codexAdapter.getFilePath('explore');
      expect(filePath).toMatch(/prompts[/\\]opsp-explore\.md$/);
    });
    ...
    it('should default to homedir/.codex', () => {
      ...
      try {
        const filePath = codexAdapter.getFilePath('explore');
        const expected = path.join(os.homedir(), '.codex', 'prompts', 'opsp-explore.md');
    ...
    it('should respect CODEX_HOME env var', () => {
      ...
      try {
        const filePath = codexAdapter.getFilePath('explore');
        expect(filePath).toBe(path.join(path.resolve('/custom/codex-home'), 'prompts', 'opsp-explore.md'));
      } finally {
        if (original !== undefined) {
          process.env.CODEX_HOME = original;
        } else {
  ...
  describe('codebuddyAdapter', () => {
    ...
    it('should generate correct file path with nested opsp folder', () => {
      const filePath = codebuddyAdapter.getFilePath('explore');
      expect(filePath).toBe(path.join('.codebuddy', 'commands', 'opsp', 'explore.md'));
    });
  ...
  describe('continueAdapter', () => {
    ...
    it('should generate correct file path with .prompt extension', () => {
      ...
      expect(filePath).toBe(path.join('.continue', 'prompts', 'opsp-explore.prompt'));
    });
  ...
  describe('costrictAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.cospec', 'openspecpowers', 'commands', 'opsp-explore.md'));
    });
  ...
  describe('crushAdapter', () => {
    ...
    it('should generate correct file path with nested opsp folder', () => {
      ...
      expect(filePath).toBe(path.join('.crush', 'commands', 'opsp', 'explore.md'));
    });
  ...
  describe('factoryAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.factory', 'commands', 'opsp-explore.md'));
    });
  ...
  describe('geminiAdapter', () => {
    ...
    it('should generate correct file path with .toml extension', () => {
      ...
      expect(filePath).toBe(path.join('.gemini', 'commands', 'opsp', 'explore.toml'));
    });
  ...
  describe('githubCopilotAdapter', () => {
    ...
    it('should generate correct file path with .prompt.md extension', () => {
      ...
      expect(filePath).toBe(path.join('.github', 'prompts', 'opsp-explore.prompt.md'));
    });
  ...
  describe('iflowAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.iflow', 'commands', 'opsp-explore.md'));
    });
  ...
  describe('kilocodeAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.kilocode', 'workflows', 'opsp-explore.md'));
    });
  ...
  describe('opencodeAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.opencode', 'commands', 'opsp-explore.md'));
    });
    ...
    it('should transform colon-based command references to hyphen-based', () => {
      const contentWithCommands: CommandContent = {
        ...sampleContent,
        body: 'Use /opsp:new to start, then /opsp:apply to implement.',
      };
      const output = opencodeAdapter.formatFile(contentWithCommands);
      expect(output).toContain('/opsp-new');
      expect(output).toContain('/opsp-apply');
      expect(output).not.toContain('/opsp:new');
      expect(output).not.toContain('/opsp:apply');
    });

    it('should handle multiple command references in body', () => {
      const contentWithMultipleCommands: CommandContent = {
        ...sampleContent,
        body: `/opsp:explore for ideas
/opsp:new to create
/opsp:continue to proceed
/opsp:apply to implement`,
      };
      const output = opencodeAdapter.formatFile(contentWithMultipleCommands);
      expect(output).toContain('/opsp-explore');
      expect(output).toContain('/opsp-new');
      expect(output).toContain('/opsp-continue');
      expect(output).toContain('/opsp-apply');
    });
  });
  ...
  describe('qoderAdapter', () => {
    ...
    it('should generate correct file path with nested opsp folder', () => {
      ...
      expect(filePath).toBe(path.join('.qoder', 'commands', 'opsp', 'explore.md'));
    });
  ...
  describe('qwenAdapter', () => {
    ...
    it('should generate correct file path with .toml extension', () => {
      ...
      expect(filePath).toBe(path.join('.qwen', 'commands', 'opsp-explore.toml'));
    });
  ...
  describe('piAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.pi', 'prompts', 'opsp-explore.md'));
    });

    it('should generate correct file paths for different commands', () => {
      expect(piAdapter.getFilePath('new')).toBe(path.join('.pi', 'prompts', 'opsp-new.md'));
      expect(piAdapter.getFilePath('bulk-archive')).toBe(path.join('.pi', 'prompts', 'opsp-bulk-archive.md'));
    });
  ...
  describe('roocodeAdapter', () => {
    ...
    it('should generate correct file path', () => {
      ...
      expect(filePath).toBe(path.join('.roo', 'commands', 'opsp-explore.md'));
    });
  ...
  describe('cross-platform path handling', () => {
    it('Claude adapter uses path.join for paths', () => {
      ...
      expect(filePath.split(path.sep)).toEqual(['.claude', 'commands', 'opsp', 'test.md']);
    });

    it('Cursor adapter uses path.join for paths', () => {
      const filePath = cursorAdapter.getFilePath('test');
      expect(filePath.split(path.sep)).toEqual(['.cursor', 'commands', 'opsp-test.md']);
    });

    it('Windsurf adapter uses path.join for paths', () => {
      const filePath = windsurfAdapter.getFilePath('test');
      expect(filePath.split(path.sep)).toEqual(['.windsurf', 'workflows', 'opsp-test.md']);
    });
