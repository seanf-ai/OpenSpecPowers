...
describe('interactive utilities', () => {
  let originalOpenSpecPowersInteractive: string | undefined;
  let originalCI: string | undefined;
  let originalStdinIsTTY: boolean | undefined;

  beforeEach(() => {
    // Save original environment
    originalOpenSpecPowersInteractive = process.env.OPEN_SPEC_INTERACTIVE;
  ...
  afterEach(() => {
    ...
    if (originalOpenSpecPowersInteractive !== undefined) {
      process.env.OPEN_SPEC_INTERACTIVE = originalOpenSpecPowersInteractive;
    } else {
      delete process.env.OPEN_SPEC_INTERACTIVE;
    }
