...
## Command Syntax
```bash
openspecpowers archive [change-name] [--yes|-y] [--skip-specs]
```
...
- **THEN** execute these steps:
  ...
  4. If confirmed, for each capability spec in the change directory:
     - Copy the spec from `changes/[name]/specs/[capability]/spec.md` to `openspecpowers/specs/[capability]/spec.md`
