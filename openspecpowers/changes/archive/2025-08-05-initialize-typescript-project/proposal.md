...
## Why
The OpenSpecPowers project needs a proper TypeScript foundation to build the minimal CLI that helps developers set up OpenSpecPowers file structures and keep AI instructions updated.
