...
## 1. Restructure OpenSpecPowers README.md
...
- [x] 3.1 Document `openspecpowers list` and `openspecpowers list --specs` commands
- [x] 3.2 Document `openspecpowers show` with all flags and interactive mode
- [x] 3.3 Document `openspecpowers diff [change]` for viewing spec differences
- [x] 3.4 Document `openspecpowers archive` with --skip-specs option
- [x] 3.5 Document `openspecpowers validate` with --strict and batch modes
- [x] 3.6 Document `openspecpowers init` and `openspecpowers update` commands
...
- [x] 8.2 Run `openspecpowers init` to verify CLAUDE.md generation
