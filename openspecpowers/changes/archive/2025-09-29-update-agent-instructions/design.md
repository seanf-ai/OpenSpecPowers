...
- **`openspecpowers list` prominence** - Essential for discovering changes and specs
...
- **Deprecation cleanup** - Remove noun-first patterns (openspecpowers change show)
...
- Use `openspecpowers list --specs` to discover current capabilities
