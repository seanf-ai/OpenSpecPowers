# Adopt Future State Storage for OpenSpecPowers Changes
...
- Add new `openspecpowers-conventions` capability to document these conventions



## Impact

- Affected specs: New `openspecpowers-conventions` capability
- Affected code: 
  - openspecpowers/README.md (lines 85-108)
  - docs/PRD.md (lines 376-382, 778-783)
  - docs/openspecpowers-walkthrough.md (lines 58-62, 112-126)
  - openspecpowers/changes/add-init-command/ (migration needed)
