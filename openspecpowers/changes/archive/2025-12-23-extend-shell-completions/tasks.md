...
- [x] Verify bash completions work manually: `openspecpowers completion install bash && exec bash`
...
- [x] Verify fish completions work manually: `openspecpowers completion install fish`
...
- [x] Run `openspecpowers validate extend-shell-completions --strict` and resolve all issues
- [x] Update error messages to list all four supported shells
- [x] Verify `openspecpowers completion --help` documentation is current
