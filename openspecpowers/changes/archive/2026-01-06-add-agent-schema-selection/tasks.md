...
- [x] 1.2 Ensure `openspecpowers templates --schema <name>` returns artifact list for any schema
...
- [x] 2.3 Pass selected schema to `openspecpowers new change --schema <name>`
...
- [x] 3.2 Read artifact list dynamically from `openspecpowers status --json`
