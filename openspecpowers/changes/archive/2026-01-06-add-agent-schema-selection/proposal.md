...
- Update `openspecpowers-new-change` skill to prompt user for schema selection
- Update `openspecpowers-continue-change` skill to work with any schema's artifacts
- Update `openspecpowers-apply-change` skill to handle schema-specific task structures
