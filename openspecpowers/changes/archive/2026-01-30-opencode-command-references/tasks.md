...
- [x] 3.3 Run `openspecpowers init --tools opencode` in a temp directory and verify:
  - Command files in `.opencode/command/` contain `/opsp-` references (not `/opsp:`)
  - Skill files in `.opencode/skills/` contain `/opsp-` references (not `/opsp:`)
