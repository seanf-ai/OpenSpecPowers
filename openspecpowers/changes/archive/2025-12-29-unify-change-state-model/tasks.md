...
- [x] Add test for `openspecpowers status --change <scaffolded-change>`
- [x] Add test for `openspecpowers next --change <scaffolded-change>`
- [x] Add test for `openspecpowers instructions proposal --change <scaffolded-change>`
...
- [x] Manual test: `openspecpowers new change foo && openspecpowers status --change foo`
- [x] Manual test: `openspecpowers new change foo && openspecpowers view` shows foo in Draft
- [x] Validate with `openspecpowers validate unify-change-state-model --strict`
