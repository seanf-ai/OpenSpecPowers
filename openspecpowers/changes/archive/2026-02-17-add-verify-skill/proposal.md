...
- Update help text to include `/opsp:verify` in the list of available commands
- Create `opsp-verify-skill` capability spec
...
- Affected specs: New `opsp-verify-skill` spec
- Affected code:
...
- Generated artifacts: When users run `openspecpowers artifact-experimental-setup`:
  - Creates `.claude/skills/openspecpowers-verify-change/SKILL.md`
  - Creates `.claude/commands/opsp/verify.md`
- Related skills: Works alongside `/opsp:apply` and before `/opsp:archive`
