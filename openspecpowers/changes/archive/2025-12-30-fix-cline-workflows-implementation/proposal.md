...
- **BREAKING**: Existing Cline users will need to re-run `openspecpowers init` to get the corrected workflow files
...
- Modified files: `.clinerules/workflows/openspecpowers-*.md` (moved from `.clinerules/openspecpowers-*.md`)
