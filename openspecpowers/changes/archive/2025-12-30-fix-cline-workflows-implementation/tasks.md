...
- [x] Change FILE_PATHS in `src/core/configurators/slash/cline.ts` from `.clinerules/openspecpowers-*.md` to `.clinerules/workflows/openspecpowers-*.md`
...
- [x] Verify the change follows OpenSpecPowers conventions
