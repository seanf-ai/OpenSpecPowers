...
- [x] Rename `openspecpowers/README.md` to `openspecpowers/AGENTS.md`
...
- [x] Modify `openspecpowers init` to generate `AGENTS.md`
- [x] Update `openspecpowers update` to refresh `AGENTS.md`
- [x] Ensure CLAUDE.md markers link to `@openspecpowers/AGENTS.md`

## 4. Update Specifications
- [x] Modify `cli-init` spec to reference `AGENTS.md`
- [x] Modify `cli-update` spec to reference `AGENTS.md`
- [x] Modify `openspecpowers-conventions` spec to include `AGENTS.md` in project structure
