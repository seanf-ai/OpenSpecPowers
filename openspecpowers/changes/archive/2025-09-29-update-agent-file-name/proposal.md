...
## Problem
The agent instructions live in `openspecpowers/README.md`, which clashes with conventional project README usage and creates confusion for tooling and contributors.

## Solution
Rename the agent instruction file to `openspecpowers/AGENTS.md` and update OpenSpecPowers tooling to use the new filename:
- `openspecpowers init` generates `AGENTS.md` instead of `README.md`
...
## Success Metrics
- `openspecpowers init` creates `openspecpowers/AGENTS.md`
- `openspecpowers update` refreshes `AGENTS.md`
- All specs reference `openspecpowers/AGENTS.md`
