...
- [x] 2.1 Create or extend global config module for `~/.config/openspecpowers/config.json`
...
- [x] 4.3 Display notice text: "Note: OpenSpecPowers collects anonymous usage stats. Opt out: OPENSPEC_TELEMETRY=0"
