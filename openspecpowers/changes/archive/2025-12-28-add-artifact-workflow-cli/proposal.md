...
- **NEW**: `openspecpowers status --change <id>` shows artifact completion state
- **NEW**: `openspecpowers next --change <id>` shows artifacts ready to create
- **NEW**: `openspecpowers instructions <artifact> --change <id>` outputs enriched template
- **NEW**: `openspecpowers templates [--schema <name>]` shows resolved template paths
- **NEW**: `openspecpowers new change <name>` creates a new change directory
