...
This module will coexist with the current OpenSpecPowers system as a parallel capability, potentially enabling future migration or integration.
...
- Replacing existing OpenSpecPowers functionality
...
**Resolution order:**
1. `${XDG_DATA_HOME:-~/.local/share}/openspecpowers/schemas/<name>.yaml` - Global user override
...
- Unix/macOS fallback: `~/.local/share/openspecpowers/`
- Windows fallback: `%LOCALAPPDATA%/openspecpowers/`
...
- Global user override: `${XDG_DATA_HOME:-~/.local/share}/openspecpowers/schemas/<name>.yaml`
