## Why
Add support for Crush AI assistant in OpenSpecPowers to enable developers to use Crush's enhanced capabilities for spec-driven development workflows.
...
- New files: .crush/commands/openspecpowers/ (proposal.md, apply.md, archive.md)