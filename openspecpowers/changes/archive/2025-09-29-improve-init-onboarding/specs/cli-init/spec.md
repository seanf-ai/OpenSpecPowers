...
Instructions for AI coding assistants using OpenSpecPowers for spec-driven development.

## TL;DR Quick Checklist
- Search existing work: `openspecpowers spec list --long`, `openspecpowers list`
...
- Validate with `openspecpowers validate [change-id] --strict`
...
- **AND** summarize which assistant files were created versus refreshed (e.g., `CLAUDE.md (created)`, `.cursor/commands/openspecpowers-apply.md (refreshed)`)
