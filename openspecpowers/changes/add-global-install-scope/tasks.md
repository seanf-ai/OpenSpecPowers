...
- [ ] 1.4 Extend `openspecpowers config list` output to show install scope and source (`explicit`, `new-default`, `legacy-default`)
...
- [ ] 4.1 Add scope override flag to `openspecpowers init` (`--scope global|project`)
...
- [ ] 5.1 Add scope override flag to `openspecpowers update` (`--scope global|project`)
...
- [ ] 6.1 Extend `openspecpowers config profile` interactive flow to select install scope
