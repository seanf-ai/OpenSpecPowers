...
Define the install scope model for OpenSpecPowers-generated skills and commands, including scope preference, effective scope resolution, and fallback/error semantics.
...
- **AND** SHALL automatically remove only OpenSpecPowers-managed files in the previous effective scope
