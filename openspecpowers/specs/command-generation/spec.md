...
## Purpose
Define tool-agnostic command content and adapter contracts for generating tool-specific OpenSpecPowers command files.
...
- **THEN** `CommandContent` SHALL include:
  ...
  - `name`: human-readable name (e.g., 'OpenSpecPowers Explore')
  - `description`: brief description of command purpose
  - `category`: grouping category (e.g., 'OpenSpecPowers')
...
- **WHEN** generating all opsp commands for a tool
