...
- **WHEN** `openspecpowers/AGENTS.md` is regenerated or updated
...
`openspecpowers/AGENTS.md` SHALL include complete copy/paste templates and inline examples exactly where agents make corresponding edits.
...
`openspecpowers/AGENTS.md` SHALL offer a concise pre-validation checklist that highlights common formatting mistakes before running `openspecpowers validate`.
...
- **WHEN** reorganizing `openspecpowers/AGENTS.md`
...
- **WHEN** `openspecpowers/AGENTS.md` explains how to write `spec.md`
