 ...
 * Stores anonymous ID and notice-seen flag in ~/.config/openspecpowers/config.json
 */
 ...
 * Uses ~/.config/openspecpowers/config.json on all platforms.
 */
export function getConfigPath(): string {
  const configDir = path.join(os.homedir(), '.config', 'openspecpowers');
