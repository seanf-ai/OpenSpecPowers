...
// Constants
export const GLOBAL_CONFIG_DIR_NAME = 'openspecpowers';
export const GLOBAL_CONFIG_FILE_NAME = 'config.json';
export const GLOBAL_DATA_DIR_NAME = 'openspecpowers';
 ...
 *
 * - All platforms: $XDG_CONFIG_HOME/openspecpowers/ if XDG_CONFIG_HOME is set
 * - Unix/macOS fallback: ~/.config/openspecpowers/
 * - Windows fallback: %APPDATA%/openspecpowers/
 */
 ...
 *
 * - All platforms: $XDG_DATA_HOME/openspecpowers/ if XDG_DATA_HOME is set
