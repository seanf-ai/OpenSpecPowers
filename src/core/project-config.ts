 ...
 *
 * @param projectRoot - The root directory of the project (where `openspecpowers/` lives)
...
export function readProjectConfig(projectRoot: string): ProjectConfig | null {
  ...
  try {
    ...
    if (!raw || typeof raw !== 'object') {
      console.warn(`openspecpowers/config.yaml is not a valid YAML object`);
      return null;
    }
    ...
    console.warn(`Failed to parse openspecpowers/config.yaml:`, error);
    return null;
  }
}
