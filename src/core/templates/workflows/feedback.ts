...
export function getFeedbackSkillTemplate(): SkillTemplate {
  return {
    name: 'feedback',
    description: 'Collect and submit user feedback about OpenSpecPowers with context enrichment and anonymization.',
    instructions: `Help the user submit feedback about OpenSpecPowers.
...
5. **Submit on confirmation**
   - Use the \`openspecpowers feedback\` command to submit
   - Format: \`openspecpowers feedback "title" --body "body content"\`
