...
/**
 * Registry of all OpenSpecPowers CLI commands with their flags and metadata.
...
export const COMMAND_REGISTRY: CommandDefinition[] = [
  ...
  {
    name: 'change',
    description: 'Manage OpenSpecPowers change proposals (deprecated)',
    flags: [],
    subcommands: [
      {
        name: 'show',
  ...
  {
    name: 'spec',
    description: 'Manage OpenSpecPowers specifications',
    flags: [],
    subcommands: [
      {
        name: 'show',
